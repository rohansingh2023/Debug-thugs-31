      ...
      <div>
        <div>
          <div className="relative">
            <img className="w-full" src="../images/plant1.jpg" />
      ...
      >
        ...
        <div className="rounded overflow-hidden shadow-lg hover:scale-105">
          ...
          <div className="px-6 py-4">
            ...
            <button
              className="absolute mt-5 bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded"
